...
class ImageDenoiserModelV1(nn.Module):
    def __init__(self, c_in, feats_in, depths, channels, self_attn_depths, cross_attn_depths=None, mapping_cond_dim=0, unet_cond_dim=0, cross_cond_dim=0, dropout_rate=0., patch_size=1, skip_stages=0, has_variance=False, c_out=1):
        super().__init__()
        self.c_in = c_in
        ...
        self.proj_out = nn.Conv2d(channels[max(0, skip_stages - 1)], c_out, 1)
